...
namespace app::lua_bind {
    namespace StatusModule {
        ...
        u64 prev_situation_kind(u64) asm("_ZN3app8lua_bind38StatusModule__prev_situation_kind_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 prev_status_kind(u64,u64) asm("_ZN3app8lua_bind35StatusModule__prev_status_kind_implEPNS_26BattleObjectModuleAccessorEj") LINKABLE;
